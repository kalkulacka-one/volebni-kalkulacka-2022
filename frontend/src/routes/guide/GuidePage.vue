...
Čeká vás 98 otázek. Na stejné otázky nám odpověděly kandidující osobnosti. Zodpovězení otázek zabere zhruba 10 minut. Na konci se dozvíte, jak se jednotliví kandidáti a kandidátky shodují s vašimi názory.
    ...
    ? `
Volební kalkulačka pro mladé byla vytvořena ve **spolupráci s projektem [NázoryPolitiků.cz](https://www.nazorypolitiku.cz)**. Tato iniciativa již třetím rokem před volbami přináší odpovědi kandidátů na otázky rezonující společností, zejména mezi mladými.

Projekt vznikl v roce 2020 jako iniciativa středoškolských studentů a ve formě studentského spolku funguje dosud. Tým se z původní dvojice rozrostl na **15 studentů, kteří se snaží pomáhat voličům** orientovat se v názorech kandidátů. Za 3 roky fungování pomohl projekt s rozhodováním více než 100 000 voličů. 
