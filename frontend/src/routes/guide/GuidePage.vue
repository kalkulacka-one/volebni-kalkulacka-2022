      ...
      <BottomBarWrapper>
        <StepWrapper centered>
          ...
          <StackComponent v-if="currentStep === 2" spacing="small">
            ...
            <BodyText size="medium">Versiunea pentru alegerile prezidențiale din 2025 are 21 de afirmații cu 2 variante de răspuns (sunt de acord / nu sunt de acord).</BodyText> <!-- TODO25 new text? -->
            <CardComponent
              corner="bottom-right"
              border
